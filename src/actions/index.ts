...
export const assignBook = (book_key: DataTypes.BookKeyType) => ({ type: ActionTypes.ACTION_USER_DATA, book_key })
export const returnBook = (book_key: DataTypes.BookKeyType) => ({ type: ActionTypes.ACTION_USER_DATA, book_key })